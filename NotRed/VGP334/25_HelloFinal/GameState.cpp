...
void MainState::Initialize()
{
	...
	}
	{
		...
		info.minParticlesPerEmit = 146;
		info.maxParticlesPerEmit = 146;
		info.minTimeBetweenEmit = 1.12f;
		info.maxTimeBetweenEmit = 1.12f;
		info.minSpawnAngle = -90.0f * Math::Constants::Pi / 180.0f;
		info.maxSpawnAngle = 90.0f * Math::Constants::Pi / 180.0f;
		info.minSpeed = 10.0f;
		info.maxSpeed = 20.0f;
		info.minParticleLifeTime = 10.0f;
		info.maxParticleLifeTime = 14.0f;
